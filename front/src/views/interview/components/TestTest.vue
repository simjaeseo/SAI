<template>
  ...
  <div class="components">
    <div class="switch">
      <div class="switch__1">
        <label for="switch-1"><input id="switch-1" type="checkbox"></label>
      </div>
      <div class="switch__2">
        <label for="switch-2"><input id="switch-2" type="checkbox" checked></label>
      </div>
    </div>
    <div class="checkbox">
      <div class="checkbox__1">
        <label for="checkbox-1">
          <input id="checkbox-1" type="checkbox"><i class="material-icons">done</i></label>
      </div>
      <div class="checkbox__2">
        <label for="checkbox-2">
          <input id="checkbox-2" type="checkbox" checked><i class="material-icons">done</i></label>
      </div>
    </div>
    <div class="radio">
      <div class="radio__1">
        <label for="radio-1"><input id="radio-1" type="radio"  name="radio" value="1"></label>
      </div>
      <div class="radio__2">
        <label for="radio-2"><input id="radio-2" type="radio"
        name="radio" value="2" checked></label>
      </div>
    </div>
...
export default {
  ...
  mounted() {}, // 템플릿 내 HTML DOM이 화면에 로딩이 되는 순간, 마운트가 다 끝난 순간 실행
  unmounted() {}, // 컴포넌트 이동 시 unmount가 일어나면서 해당 코드 자동 실행
  methods: {}, // 함수 정의해서 컴포넌트 내에서 사용 가능하게 함
};
</script>
...
.switch__1 label::before, .switch__2 label::before {
  ...
  background: linear-gradient(330deg, var(--primary-dark)
   0%, var(--primary) 50%, var(--primary-light) 100%);
  opacity: 0;
  transition: all 0.4s ease;
}
...
.slider__color {
  ...
  border-radius: inherit;
  background: var(--primary);
  background: linear-gradient(-1deg, var(--primary-dark) 0%,
   var(--primary) 50%, var(--primary-light) 100%);
}
.slider__tooltip {
  position: absolute;
  top: 2.6rem;
